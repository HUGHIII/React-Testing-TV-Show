...
// test ('episodes comp renders correctly', () => {
//     const mockEpisodes = jest.fn();
//     const {getByText} = render (
//         <Episodes episodes={mockEpisodes}/>
//     );
//     expect(getByText(/episodes/i)).toBeInTheDocument();
// })
...
test ('episode info renders',()=>{
    const {queryAllByTestId} = render(<Episodes episodes={episodes}/>);

    expect(queryAllByTestId(/episode-info-test/i)).toHaveLength(26);
